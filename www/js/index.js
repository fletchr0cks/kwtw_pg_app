...
function showLocal() {
    for (var i = 0; i < localStorage.length; i++) {
        ...
        if (localStorage.key(i).indexOf(str) > -1) {
            $('#status_msgs2').append("</br > " + localStorage.key(i) + " data: " + localStorage.getItem(localStorage.key(i)));
            // }
        }
    ...
    $('#status_msgs2').append("</br > st: " + localStorage.getItem('oauthio_provider_strava'));
...
function checkLoc() {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        $('#status_msgs2').append("</br > no location");
        return 0;
    });
